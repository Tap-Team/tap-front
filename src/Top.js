            ...
            <div className="top-wrapper">
                ...
                <div className="service-container">
                    ...
                    <div className="service-card1">
                        ...
                        <img className="service-img" src={imgBc} alt=""/>
                    ...
                    <div className="service-card3">
                        <div className="gray-box"></div>
                        <img className="service-img" src={imgIdea} alt=""/>
                        <div className="service-explain">
                            <h1>『俺が先だがシステム』</h1>
                    ...
                    <div className="service-card4">
                        <div className="gray-box"></div>
                        <img className="service-img" src={imgWant} alt=""/>
                        <div className="service-explain">
                            <h1>『それ欲しいシステム』</h1>
                            <p>トークンの移転機能</p>
                        </div>
                    ...
                    <div className="service-card5">
                        <div className="gray-box"></div>
                        <img className="service-img" src={imgStop} alt=""/>
                        <div className="service-explain">
                            <h1>『ちょっと待てシステム』</h1>
